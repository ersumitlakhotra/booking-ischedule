...
import { getTax, openMaps, updateField } from "../../common/general.jsx";
...
export default function SummaryInfo({ form, setForm }) {
    const [isLoading, setIsLoading] = useState(false);
    const { userList, companyList, getAppointment, getCustomer, getDiscount } = useOutletContext();
